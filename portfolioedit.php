      ...
      <div class="album py-5 bg-light">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="a-editar">
                <h4>Capa</h4>
                <div class="capa-projeto" style="background-image: url('<?php echo SITE_BASE."/uploads/".$ln->logo; ?>')">
                ...
                <div class="a-fotos">
                    <?php
                        ...
                        ?>
                            <div class="foto" style="background-image: url('<?php echo SITE_BASE."/uploads/".$fotos->photo; ?>')">
                    ...
                    ?>
                    <div class="foto">
                        <div class="btn-add-foto bg-primary">+</div>
                    </div>
                </div>
            </div>
            <?php
